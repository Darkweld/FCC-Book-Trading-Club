...
var BookOverlay = function (_React$Component) {
	_inherits(BookOverlay, _React$Component);

	function BookOverlay() {
		_classCallCheck(this, BookOverlay);

		return _possibleConstructorReturn(this, (BookOverlay.__proto__ || Object.getPrototypeOf(BookOverlay)).apply(this, arguments));
	}

	_createClass(BookOverlay, [{
		key: "render",
		value: function render() {
			var author = this.props.author ? React.createElement(
				"p",
...
var Book = function (_React$Component2) {
	...
	_createClass(Book, [{
		...
		value: function render() {
			...
			return React.createElement(
				"div",
				{ className: "bookDiv", onClick: function onClick(e) {
						return _this3.props.click(e, _this3.props.userName);
					} },
				React.createElement("img", { className: "bookImage", src: this.props.imgSRC }),
				React.createElement(BookOverlay, { title: this.props.title, author: this.props.author, user: this.props.userName })
			);
		}
	}]);
...
var Main = function (_React$Component3) {
	...
	function Main() {
		...
		_this4.state = { bookData: [] };
		_this4.handleBookClick = _this4.handleBookClick.bind(_this4);
		return _this4;
	}
	...
	_createClass(Main, [{
		...
		value: function componentDidMount() {
			...
			fetch("https://peaceful-forest-57401.herokuapp.com/bookListIndex").then(function (response) {
				return response.json();
			}).then(function (data) {
				return _this5.setState({ bookData: data });
			});
		}
	}, {
		key: "handleBookClick",
		value: function handleBookClick(e, val) {
