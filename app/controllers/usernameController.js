...
form.addEventListener('submit', function(event) {
	...
	xhttp.request('POST', mainUrl + '/checkUsername/' + formval.value, function(data) {
		...
		if (yourUsername) return yourUsername.textContent = "Your new book-club username is: " + data.success;
		
		var text = document.createElement('p');
		text.classname = 'boldText';
		text.id = "yourUsername";
		text.textContent = "Your new book-club username is: " + data.success;
